...
<div class="max-w-2xl mx-auto p-6 bg-white rounded-lg shadow">
    <h1 class="text-2xl font-bold mb-6">Add Navigation</h1>
    <form action="{{ route('navigations.store') }}" method="POST">
        @csrf
        <div class="mb-4">
            <label class="block text-gray-700 font-semibold mb-2">Label</label>
            <input type="text" name="label" value="{{ old('label') }}" class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-teal-500 focus:border-teal-500" placeholder="Navigation label" required>
        ...
        <div class="mb-4">
            ...
            <input type="text" name="route" value="{{ old('route') }}" class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-teal-500 focus:border-teal-500" placeholder="e.g., dashboard or abouts.index">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="icon" value="{{ old('icon') }}" class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-teal-500 focus:border-teal-500" placeholder="e.g., home, settings, users">
